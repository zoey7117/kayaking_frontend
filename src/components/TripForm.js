      ...
      <form onSubmit={this.handleOnSubmit}>
        <div className="ui form">
          <div className="fields">
            ...
            <div className="three wide field">
              <DateInput onChange={this.handleOnChange} type={this.DateInput} dateFormat="MM-DD-YY" value={this.state.end_date} animation='off' iconPosition="left"  name="end_date" placeholder="end date"   autoComplete="off"/>
